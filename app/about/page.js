...
.
        ...
        <h1 className="m-3 text-2xl italic font-bold text-center text-teal-600">ذِكْرَى بالأرقام </h1>
        <div className={style.part1}>
          <div className={style.inner}>
          <h1  className="m-3 text-2xl italic font-bold text-center text-teal-600">2023</h1>
          <p className={`${style.p1} dark:text-white`} >سَنَّةُ النَّشْأَة </p>
          </div>
          <div className={style.inner}>
          <h1  className="m-3 text-2xl italic font-bold text-center text-teal-600">10+</h1>
          <p className={`${style.p1} dark:text-white`} >عَدَدِ الْقُرَّاءِ</p>
          </div>
          <div className={style.inner}>
          <h1  className="m-3 text-2xl italic font-bold text-center text-teal-600">1000+</h1>
          <p className={`${style.p1} dark:text-white`} >المستخدمين الفعالين</p>
          </div>
          <div className={style.inner}>
          <h1  className="m-3 text-2xl italic font-bold text-center text-teal-600">75 L</h1>
          <p className={`${style.p1} dark:text-white`}  >زمزم في الشهر</p>
          </div>
          <div className={style.inner}>
          <h1  className="m-3 text-2xl italic font-bold text-center text-teal-600">300+ JD</h1>
          <p className={`${style.p1} dark:text-white`} >معدل أموال الصدقة</p>
          </div>
          <div className={style.inner}>
          <h1  className="m-3 text-2xl italic font-bold text-center text-teal-600">12</h1>
