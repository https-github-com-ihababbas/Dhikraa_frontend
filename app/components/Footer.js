        ...
        <footer className="p-4 sm:p-6 bg-[#252f0b]">
            <div className="md:flex md:justify-between ">
                ...
                <div className="border-white border-l-2">
                    <h1 className="text-2xl text-right text-[#e5f2c4] py-14 pl-8" >كل نقطة نهاية هي نقطة بداية في رحلة طلب العلم</h1>
                </div>
                <div className=" mb-6 md:mb-0">
                    <a href="/" target="_blank" className="border-black flex items-center">
                        <Image src={logo} className="w-32 mr-4 h-36" alt="FlowBite Logo" />
                    </a>
                </div>
            </div>
            <br className="my-6 sm:mx-auto dark:border-gray-700 lg:my-8" />
            <div className="sm:flex sm:items-center sm:justify-between">

                <div className="ml-8 flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="#" className="text-[#949e7b] hover:text-[#e5f2c4] dark:hover:text-white">
                ...
                <span className="text-sm text-[#949e7b] mr-8 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" target="_blank" className="hover:underline">Dhikraa™</a>. All Rights Reserved.
                </span>
            </div>
        </footer>
    )
