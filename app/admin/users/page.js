                      ...
                      <div class="flex-auto px-4 bg-[#949e7b] rounded-xl">
                        <div class="flex flex-wrap mt-4">
                          ...
                          <div class="relative w-full pr-4 max-w-full flex-grow flex-1 text-right ">
                            ...
                            <span class="font-bold text-xl  text-[#252f0b]  text-[#252f0b]">{female}</span>
                          </div>
                      ...
                      <div class="flex-auto px-4 bg-[#949e7b] rounded-xl">
                        <div class="flex flex-wrap mt-4">
                          ...
                          <div class="relative w-full pr-4 max-w-full flex-grow flex-1 text-right ">
                            ...
                            <span class="font-bold text-xl  text-[#252f0b] ">{male}</span>
                          </div>
                      ...
                      <div class="flex-auto px-4 bg-[#949e7b] rounded-xl">
                        <div class="flex flex-wrap mt-4">
                          ...
                          <div class="relative w-full pr-4 max-w-full flex-grow flex-1 text-right ">
                            ...
                            <span class="font-bold text-xl  text-[#252f0b] ">{admin}</span>
                          </div>
                      ...
                      <div class="flex-auto px-4 bg-[#949e7b] rounded-xl">
                        <div class="flex flex-wrap mt-4">
                          ...
                          <div class="relative w-full pr-4 max-w-full flex-grow flex-1 text-right  ">
                            ...
                            <span class="font-bold text-xl text-[#252f0b] ">{users.length}</span>
                          </div>
